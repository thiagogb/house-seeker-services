...
class UrbanPropertyPriceVariationsDataRequestBuilderTest {

    private static final String ALL_PROJECTIONS = "id: true urban_property: true analysis_date: true type: true price: true variation: true";
    ...
    void givenAEmptyProjections_whenCallsBuild_thenExpectsToProjectAllAttributes() {
        var response = UrbanPropertyPriceVariationsDataRequestBuilder.newInstance()
    ...
    void givenAProjectionListWithCorrectPrefix_whenCallsBuild_thenExpectsToProjectOnlySpecifiedAttributes() {
        var response = UrbanPropertyPriceVariationsDataRequestBuilder.newInstance()
                                                                     .withProjections(Set.of(
                                                                             "rows/id", "rows/urbanProperty", "rows/analysisDate", "rows/type",
                                                                             "rows/price", "rows/variation"
                                                                     ))
                                                                     .build();
